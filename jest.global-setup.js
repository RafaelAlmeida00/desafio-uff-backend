...
exports.default = async () => {
    ...
    (0, child_process_1.execSync)('docker-compose up -d postgres', { stdio: 'inherit' });
    ...
    while (retries > 0) {
        try {
            (0, child_process_1.execSync)('docker-compose exec -T postgres pg_isready -U desafio_user -d desafio_db', { stdio: 'ignore' });
    ...
    (0, child_process_1.execSync)('pnpm db:migrate', { stdio: 'inherit' });
